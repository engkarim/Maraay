...
INSERT INTO `employee` (`id`,`name`,`address`,`mobile`,`basic_salary`,`national_id`,`employment_date`,`departure_date`,`employee_type`) VALUES 
 ...
 (9,'أحمد','طنطا','(455) 4545-4555',250,'121221212','2015-06-01','2015-06-01',1),
 (11,'مسعد السيد السيد','طططط','(124) 1412-4124',2222,'124124124','2015-06-04',NULL,2);
...
INSERT INTO `tbl_com_blending_date` (`blending_date_id`,`date`,`total_before`,`total_after`,`incoming_blending_rate_total`,`discount_value`,`by_user_id`,`incoming_total_after`) VALUES 
 (22,'2015-05-01',86,68.80000000000001,0.20000000000000004,17.19999999999999,1,344);
...
INSERT INTO `tbl_com_blending_value` (`id`,`max_mount`,`old_max_mount`,`max_mount_price`,`old_max_mount_price`,`min_mount`,`old_min_mount`,`min_mount_price`,`old_min_mount_price`,`total_mount`,`old_total_mount`,`showen_mount`,`total_before`,`total_after`,`incoming_blending_rate`,`is_edited`,`blending_date_id`,`product_id`) VALUES 
 (62,1,NULL,40,NULL,1,NULL,2,NULL,1.05,NULL,'1.1',42,33.6,0,0,22,6),
 (63,1,NULL,20,NULL,1,NULL,2,NULL,1.1,NULL,'1.1',22,17.6,0,0,22,7),
 (64,1,NULL,20,NULL,1,NULL,2,NULL,1.1,NULL,'1.1',22,17.6,0,0,22,8);
...
INSERT INTO `tbl_com_defects_date` (`defects_date_id`,`date`,`total_before`,`total_after`,`discount_value`,`by_user_id`) VALUES 
 (22,'2015-05-01',86,68.80000000000001,17.19999999999999,1);
...
INSERT INTO `tbl_com_defects_value` (`id`,`max_mount`,`old_max_mount`,`max_mount_price`,`min_mount`,`old_min_mount`,`min_mount_price`,`old_min_mount_price`,`old_max_mount_price`,`total_mount`,`old_total_mount`,`showen_mount`,`total_before`,`total_after`,`is_edited`,`defects_date_id`,`product_id`) VALUES 
 (62,1,NULL,40,1,NULL,2,NULL,NULL,1.05,NULL,'1.1',42,33.6,0,22,6),
 (63,1,NULL,20,1,NULL,2,NULL,NULL,1.1,NULL,'1.1',22,17.6,0,22,7),
 (64,1,NULL,20,1,NULL,2,NULL,NULL,1.1,NULL,'1.1',22,17.6,0,22,8);
...
INSERT INTO `tbl_com_discount_date` (`date_id`,`date`,`by_user`,`is_completed`) VALUES 
 (44,'2015-05-01',1,1);
...
INSERT INTO `tbl_com_discount_value` (`discount_id`,`discount_value`,`old_value`,`is_edited`,`discount_date`,`product_id`) VALUES 
 (134,20,NULL,0,44,6),
 (135,20,NULL,0,44,7),
 (136,20,NULL,0,44,8);
...
INSERT INTO `tbl_com_incoming_date` (`incoming_date_id`,`date`,`total_before`,`total_after`,`discount_value`,`by_user_id`) VALUES 
 (31,'2015-05-01',430,344,86,1);
...
INSERT INTO `tbl_com_incoming_value` (`incoming_value_id`,`max_mount`,`old_max_mount`,`max_mount_price`,`old_max_mount_price`,`min_mount`,`old_min_mount`,`min_mount_price`,`old_min_mount_price`,`total_mount`,`old_total_mount`,`showen_mount`,`total_before`,`total_after`,`is_edited`,`incoming_date_id`,`product_id`) VALUES 
 (89,5,NULL,200,NULL,5,NULL,10,NULL,5.25,NULL,'5.5',210,168,0,31,6),
 (90,5,NULL,100,NULL,5,NULL,10,NULL,5.5,NULL,'5.5',110,88,0,31,7),
 (91,5,NULL,100,NULL,5,NULL,10,NULL,5.5,NULL,'5.5',110,88,0,31,8);
...
INSERT INTO `tbl_com_offer_date` (`offer_date_id`,`date`,`total_before`,`total_after`,`discount_value`,`by_user_id`) VALUES 
 (23,'2015-05-01',86,68.80000000000001,17.19999999999999,1);
...
INSERT INTO `tbl_com_offer_value` (`offer_value_id`,`max_mount`,`old_max_mount`,`max_mount_price`,`old_max_mount_price`,`min_mount`,`old_min_mount`,`min_mount_price`,`old_min_mount_price`,`total_mount`,`old_total_mount`,`showen_mount`,`total_before`,`total_after`,`is_edited`,`product_id`,`offer_date_id`) VALUES 
 (65,1,NULL,40,NULL,1,NULL,2,NULL,1.05,NULL,'1.1',42,33.6,0,6,23),
 (66,1,NULL,20,NULL,1,NULL,2,NULL,1.1,NULL,'1.1',22,17.6,0,7,23),
 (67,1,NULL,20,NULL,1,NULL,2,NULL,1.1,NULL,'1.1',22,17.6,0,8,23);
...
INSERT INTO `tbl_com_sales_date` (`sales_date_id`,`date`,`total_before`,`total_after`,`discount_value`,`by_user_id`) VALUES 
 (22,'2015-05-01',172,137.59999999999997,34.400000000000034,1);
...
INSERT INTO `tbl_com_sales_value` (`sales_value_id`,`total_mount`,`total_before`,`total_after`,`showen_mount`,`product_id`,`sales_date_id`) VALUES 
 (62,2.2,44,35.199999999999996,'2.2',6,22),
 (63,2.2,44,35.199999999999996,'2.2',7,22),
 (64,2.2,44,35.199999999999996,'2.2',8,22);
...
--
-- Definition of table `tbl_lu_dir_rep_driv`
--

DROP TABLE IF EXISTS `tbl_lu_dir_rep_driv`;
CREATE TABLE `tbl_lu_dir_rep_driv` (
  `dir_rep_driv_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `date` date DEFAULT NULL,
  `direction_id` int(10) unsigned DEFAULT NULL,
  `rep_id` int(10) unsigned DEFAULT NULL,
  `driv_id` int(10) unsigned DEFAULT NULL,
  `by_user_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`dir_rep_driv_id`),
  KEY `FK_tbl_lu_dir_rep_driv_1` (`direction_id`),
  KEY `FK_tbl_lu_dir_rep_driv_2` (`rep_id`),
  KEY `FK_tbl_lu_dir_rep_driv_3` (`driv_id`),
  KEY `FK_tbl_lu_dir_rep_driv_4` (`by_user_id`),
  CONSTRAINT `FK_tbl_lu_dir_rep_driv_1` FOREIGN KEY (`direction_id`) REFERENCES `direction` (`id`),
  CONSTRAINT `FK_tbl_lu_dir_rep_driv_2` FOREIGN KEY (`rep_id`) REFERENCES `employee` (`id`),
  CONSTRAINT `FK_tbl_lu_dir_rep_driv_3` FOREIGN KEY (`driv_id`) REFERENCES `employee` (`id`),
  CONSTRAINT `FK_tbl_lu_dir_rep_driv_4` FOREIGN KEY (`by_user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tbl_lu_dir_rep_driv`
--

/*!40000 ALTER TABLE `tbl_lu_dir_rep_driv` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_lu_dir_rep_driv` ENABLE KEYS */;
